...
begin
  ...
  SysMsgIdListAion := TStringList.Create;
  SkillListAion := TStringList.Create;
  ClassIdListAion := TStringList.Create;
  ClientStringsAion := TStringList.Create;
  ItemsListAion := TStringList.Create;
  Reload;
end;
...
begin
  ...
  AugmentList.Destroy;
  AugmentList := nil;
  SysMsgIdListAion.Destroy;
  SysMsgIdListAion := nil;
  ItemsListAion.Destroy;
  ItemsListAion := nil;
  ClassIdListAion.Destroy;
  ClassIdListAion := nil;
  SkillListAion.Destroy;
  SkillListAion := nil;
  ClientStringsAion.Destroy;
  ClientStringsAion := nil;
