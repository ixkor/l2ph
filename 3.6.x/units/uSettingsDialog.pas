...
uses
  ...
  winsock,
  math, 
  IniFiles, Windows, SysUtils, Classes, Controls, Forms,
  Dialogs, StdCtrls, ExtCtrls, Mask, JvExMask, ComCtrls, siComp,
  Buttons, JvSpin;
...
begin
  ...
  isLSP.Text := Options.ReadString('General','isLSP', AppPath+'LSPprovider.dll'); //+ ПОЛНЫЙ путь. т.к. используется системой.
