...
const
  ...
  FailedLocalServer = 'Ќеудалось зарегистрировать локальный сервер на порте %d'+ #13#10+ '¬озможно этот порт зан€т другим приложением';
...
var
  ...
  mh: hmodule; //дескриптор модул€
  procs: array[0..$FFF] of dword; //массив дл€ хранени€ дескрипторов процессов
  count, cm: cardinal; //количество процессов
  i: integer;
  ModName: array[0..max_path] of char; //им€ модул€
  tmp: string;
begin
  sl.Clear;
  ...
  end else begin //≈сли WinNT/2000/XP
